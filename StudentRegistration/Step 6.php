...
<body>
<center><table border>
	<form action="registraion.php" method="GET">
	...
	<tr>
		...
		<textarea name="address" cols="138" rows = "10"></textarea>
		</td>
	</tr>
	<tr>
		<td colspan="3"><center><input type="submit" id="name" value="Done"></center></td>
		</tr>
	</form>
	</table>
</body>
